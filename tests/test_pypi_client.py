...
def test_extract_source_repo():
    ...
    info = {
        "project_urls": {"BadLink": "https://github.com/user/repo/issues", "GoodLink": "https://github.com/user/repo"}
    }
    assert client._extract_source_repo(info) == "https://github.com/user/repo"

    # Test final fallback (Line 141-148)
    info = {"project_urls": {"random_key": "https://github.com/user/repo-final"}}
